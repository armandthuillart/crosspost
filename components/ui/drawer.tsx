...
function DrawerOverlay({
	...
	return (
		<DrawerPrimitive.Overlay
			className={cn(
				"data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-foreground/20 data-[state=closed]:animate-out data-[state=open]:animate-in dark:bg-black/40",
				className,
			)}
