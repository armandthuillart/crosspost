	...
	return (
		...
		>
			...
			<SelectPrimitive.Icon asChild>
				<ChevronDownIcon
					className="-mr-1 shrink-0 in-aria-invalid:text-destructive/80 text-muted-foreground/80"
					size={16}
				/>
...
function SelectLabel({
	...
	return (
		<SelectPrimitive.Label
			className={cn(
				"py-1.5 pr-2 pl-8 font-medium text-muted-foreground text-xs",
				className,
			)}
...
function SelectItem({
	...
	return (
		<SelectPrimitive.Item
			className={cn(
				"relative flex w-full cursor-default select-none items-center rounded-md py-2 pe-8 pl-2.5 text-sm outline-hidden focus:bg-accent focus:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50",
				className,
			)}
